...
products = ["global_monthly_"+str(year)+"_"+str(month[0]).zfill(2)+"_mosaic", "global_monthly_"+str(year)+"_"+str(month[1]).zfill(2)+"_mosaic", "global_monthly_"+str(year)+"_"+str(month[2]).zfill(2)+"_mosaic", "global_monthly_"+str(year)+"_"+str(month[3]).zfill(2)+"_mosaic"] #"global_monthly_2021_04_mosaic", "global_monthly_2021_05_mosaic", "global_monthly_2021_06_mosaic", "global_monthly_2021_07_mosaic"

for roi_id in roi_id:
    for product in products:
        ROI = json_decode['features'][roi_id]['geometry']['coordinates']
        square = json_decode['features'][roi_id]['properties']['name']
        print(square)
