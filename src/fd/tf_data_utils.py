...
def _construct_norm_arrays(file_path: str, metadata_path: str, fold: int = None, filesystem: S3FS = None) -> \
    ...
    df = pd.read_csv(metadata_path) #pd.read_csv(filesystem.open(metadata_path)) if filesystem is not None else pd.read_csv(metadata_path)
    ...
    perc99 = df[['norm_perc99_b0', 'norm_perc99_b1', 'norm_perc99_b2', 'norm_perc99_b3', 'norm_perc99_b4', 'norm_perc99_b5']].values
    meanstd_mean = df[['norm_meanstd_mean_b0', 'norm_meanstd_mean_b1',
                       'norm_meanstd_mean_b2', 'norm_meanstd_mean_b3', 'norm_meanstd_mean_b4', 'norm_meanstd_mean_b5']].values
    meanstd_median = df[['norm_meanstd_median_b0', 'norm_meanstd_median_b1',
                         'norm_meanstd_median_b2', 'norm_meanstd_median_b3', 'norm_meanstd_median_b4', 'norm_meanstd_median_b5']].values
    meanstd_std = df[['norm_meanstd_std_b0', 'norm_meanstd_std_b1',
                      'norm_meanstd_std_b2', 'norm_meanstd_std_b3', 'norm_meanstd_std_b4', 'norm_meanstd_std_b5']].values
    


    #perc99 = df[['norm_perc99_b0', 'norm_perc99_b1', 'norm_perc99_b2', 'norm_perc99_b3', 'norm_perc99_b4', 'norm_perc99_b5', 'norm_perc99_b6', 'norm_perc99_b7', 'norm_perc99_b8']].values
    #meanstd_mean = df[['norm_meanstd_mean_b0', 'norm_meanstd_mean_b1',
    #                   'norm_meanstd_mean_b2', 'norm_meanstd_mean_b3', 'norm_meanstd_mean_b4', 'norm_meanstd_mean_b5', 'norm_meanstd_mean_b6', 'norm_meanstd_mean_b7', 'norm_meanstd_mean_b8']].values
    #meanstd_median = df[['norm_meanstd_median_b0', 'norm_meanstd_median_b1',
    #                     'norm_meanstd_median_b2', 'norm_meanstd_median_b3', 'norm_meanstd_median_b4', 'norm_meanstd_median_b5', 'norm_meanstd_median_b6', 'norm_meanstd_median_b7', 'norm_meanstd_median_b8']].values
    #meanstd_std = df[['norm_meanstd_std_b0', 'norm_meanstd_std_b1',
    #                  'norm_meanstd_std_b2', 'norm_meanstd_std_b3', 'norm_meanstd_std_b4', 'norm_meanstd_std_b5', 'norm_meanstd_std_b6', 'norm_meanstd_std_b7', 'norm_meanstd_std_b8']].values
...
def npz_dir_dataset(file_dir_or_list: Union[str, List[str]], features: dict, metadata_path: str,
    ...
    if randomize:
        ...
        ds = ds.shuffle(shuffle_size) #added for greater randomisation
        ds = ds.shuffle(shuffle_size) #added for greater randomisation
