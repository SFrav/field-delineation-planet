...
def calculate_normalization_factors(config: dict):
    ...
    norm_cols = [norm.format(band)
                 for norm in ['perc_99_b{0}_mean',
                              'mean_b{0}_mean',
                              'median_b{0}_mean',
                              'std_b{0}_mean'] for band in range(6)] #SF change here if altering input bands

    aggs = {}
    stat_cols = []
    stats = ['perc_99', 'mean', 'median', 'std']
    bands = list(range(6)) #SF change here if altering input bands
    ...
    df['norm_perc99_b0'], df['norm_perc99_b1'], df['norm_perc99_b2'], df['norm_perc99_b3'], df['norm_perc99_b4'], df['norm_perc99_b5'],  \
    df['norm_meanstd_mean_b0'], df['norm_meanstd_mean_b1'], df['norm_meanstd_mean_b2'], df['norm_meanstd_mean_b3'], df['norm_meanstd_mean_b4'], df['norm_meanstd_mean_b5'], \
    df['norm_meanstd_median_b0'], df['norm_meanstd_median_b1'], df['norm_meanstd_median_b2'], df['norm_meanstd_median_b3'], df['norm_meanstd_median_b4'], df['norm_meanstd_median_b5'], \
    df['norm_meanstd_std_b0'], df['norm_meanstd_std_b1'], df['norm_meanstd_std_b2'], df['norm_meanstd_std_b3'], df['norm_meanstd_std_b4'], df['norm_meanstd_std_b5'] = zip(*map(norms, df.month))


#    df['norm_perc99_b0'], df['norm_perc99_b1'], df['norm_perc99_b2'], df['norm_perc99_b3'], df['norm_perc99_b4'], df['norm_perc99_b5'], df['norm_perc99_b6'], df['norm_perc99_b7'], df['norm_perc99_b8'],  \
#    df['norm_meanstd_mean_b0'], df['norm_meanstd_mean_b1'], df['norm_meanstd_mean_b2'], df['norm_meanstd_mean_b3'], df['norm_meanstd_mean_b4'], df['norm_meanstd_mean_b5'], df['norm_meanstd_mean_b6'], df['norm_meanstd_mean_b7'], df['norm_meanstd_mean_b8'], \
#    df['norm_meanstd_median_b0'], df['norm_meanstd_median_b1'], df['norm_meanstd_median_b2'], df['norm_meanstd_median_b3'], df['norm_meanstd_median_b4'], df['norm_meanstd_median_b5'], df['norm_meanstd_median_b6'], df['norm_meanstd_median_b7'], df['norm_meanstd_median_b8'], \
#    df['norm_meanstd_std_b0'], df['norm_meanstd_std_b1'], df['norm_meanstd_std_b2'], df['norm_meanstd_std_b3'], df['norm_meanstd_std_b4'], df['norm_meanstd_std_b5'], df['norm_meanstd_std_b6'], df['norm_meanstd_std_b7'], df['norm_meanstd_std_b8'] = zip(*map(norms, df.month))
