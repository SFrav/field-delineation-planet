...
def initialise_callbacks(ds_val, config: TrainingConfig, 
    ...
    #os.makedirs(f'{model_path}/vis')
    viz_dir = os.path.join(model_path, 'viz')
    # Visualisation callback #SF added from
    visualisation_callback = ExtentBoundDistVisualizationCallback(ds_val, viz_dir)
    ...
    callbacks = [tensorboard_callback,
                 checkpoint_callback,
                 #visualisation_callback, #SF added
                 csv_logger, #SF added
